    ...
    common: {
      ...
      manageEvents: {
        ...
        feedback: {
          ...
          incorrectReasonLabel: "Lý do sai?",
          incorrectReasonPlaceholder: "Nhập lý do... (Enter để xác nhận)",
          incorrectConfirm: "Xác nhận",
          incorrectCancel: "Huỷ",
        },
      },
      deviceMode: {
    ...
    common: {
      ...
      manageEvents: {
        ...
        feedback: {
          ...
          incorrectReasonLabel: "Why is it incorrect?",
          incorrectReasonPlaceholder: "Enter reason... (Enter to confirm)",
          incorrectConfirm: "Confirm",
          incorrectCancel: "Cancel",
        },
      },
      deviceMode: {
        all: "All",
    ...
    common: {
      ...
      manageEvents: {
        ...
        feedback: {
          ...
          updating: "更新中...",
          success: "狀態已更新",
          incorrectReasonLabel: "錯誤原因？",
          incorrectReasonPlaceholder: "輸入原因... (Enter 確認)",
          incorrectConfirm: "確認",
          incorrectCancel: "取消",
        },
      },
