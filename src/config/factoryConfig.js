...
import mapCHTang2QC from '../assets/images/LayoutCHLau2QC.png';
import mapCHTang3 from '../assets/images/CH_Tang3.png';
import mapCHTang3QC from '../assets/images/LayoutCHLau3.png';
...
const configs = {
    ...
    ch: {
        ...
        floors: [
            ...
            { id: 'floor2qc', labelKey: 'floor.2qc', mapImage: mapCHTang2QC },
            { id: 'floor3', labelKey: 'floor.3', mapImage: mapCHTang3 },
            { id: 'floor3qc', labelKey: 'floor.3qc', mapImage: mapCHTang3QC },
